const translations = {
  ...
  interests: {
    ...
    messages: {
      ...
      reviewError: 'Виникла помилка під час перегляду запиту на інтерес',
      rejectSuccess: 'Запит зацікавленості відхилено',
      rejectError: 'Виникла помилка під час відхилення запиту на інтерес',
      emailCheckError: 'Виникла помилка під час перевірки електронної пошти',
      showingScheduled: 'Показ заплановано та надіслано електронний лист',
      showingError: 'Виникла помилка під час планування показу',
      fieldsRequired: 'Усі поля є обов\'язковими',
      emailCheckSuccess: 'Електронні листи успішно завантажено',
      exportSuccess: 'Запити на інтерес було експортовано до SQL',
      exportError: 'Виникла помилка під час експорту запитів на інтерес'
    },
