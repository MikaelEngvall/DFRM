...
AND a.street = 'Södra Smedjegatan' AND a.number = '3' AND a.apartment_number = 'Lgh 1301/5'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Lynn' AND t.last_name = 'Larsson'
AND a.street = 'Södra Smedjegatan' AND a.number = '3' AND a.apartment_number = 'Lgh 1201/4'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Liwaa Adin Omar' AND t.last_name = 'Bhtiti'
AND a.street = 'Södra Smedjegatan' AND a.number = '3' AND a.apartment_number = 'Lgh 1001/1'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Beiges Paola' AND t.last_name = 'Orobio'
AND a.street = 'Södra Smedjegatan' AND a.number = '3' AND a.apartment_number = 'Lgh 1201/2'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Bianca' AND t.last_name = 'Mejia'
AND a.street = 'Södra Smedjegatan' AND a.number = '3' AND a.apartment_number = 'Lgh 1101/3'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;
...
AND a.street = 'Västra Prinsgatan' AND a.number = '44' AND a.apartment_number = 'Lgh 1102/4'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Christel' AND t.last_name = 'Jnsson'
AND a.street = 'Västra Prinsgatan' AND a.number = '44' AND a.apartment_number = 'Lgh 1301/9'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Iwona' AND t.last_name = 'Slojka'
AND a.street = 'Västra Prinsgatan' AND a.number = '44' AND a.apartment_number = 'Lgh 1303/11'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Annica' AND t.last_name = 'Smlander'
AND a.street = 'Västra Prinsgatan' AND a.number = '44' AND a.apartment_number = 'Lgh 1001/1'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Ingrid Britt-Stina' AND t.last_name = 'Berglund'
AND a.street = 'Västra Prinsgatan' AND a.number = '44' AND a.apartment_number = 'Lgh 1002/2'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Konstantinos' AND t.last_name = 'Kiouros'
AND a.street = 'Västra Prinsgatan' AND a.number = '44' AND a.apartment_number = 'Lgh 1201/6'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Ludvig' AND t.last_name = 'Nilsson'
AND a.street = 'Västra Prinsgatan' AND a.number = '44' AND a.apartment_number = 'Lgh 1203/8'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Piyaphat' AND t.last_name = 'Thongkham'
AND a.street = 'Västra Prinsgatan' AND a.number = '44' AND a.apartment_number = 'Lgh 1101/3'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Maj Britt' AND t.last_name = 'Nilsson'
AND a.street = 'Västra Prinsgatan' AND a.number = '44' AND a.apartment_number = 'Lgh 1103/5'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Ville' AND t.last_name = 'Frank'
AND a.street = 'Västra Prinsgatan' AND a.number = '44' AND a.apartment_number = 'Lgh 1202/7'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Jan' AND t.last_name = 'Wallin'
AND a.street = 'Västra Prinsgatan' AND a.number = '44' AND a.apartment_number = 'Lgh 1302/10'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Tony  Mikael' AND t.last_name = 'Brandt'
AND a.street = 'Västra Vittusgatan' AND a.number = '2' AND a.apartment_number = 'Lgh 1103/107'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Allan' AND t.last_name = 'Jakoub'
AND a.street = 'Västra Vittusgatan' AND a.number = '2' AND a.apartment_number = 'Lgh 1202/110'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Obida' AND t.last_name = 'Albasha'
AND a.street = 'Västra Vittusgatan' AND a.number = '2' AND a.apartment_number = 'Lgh 1201/111'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Alina' AND t.last_name = 'Yehorova'
AND a.street = 'Västra Vittusgatan' AND a.number = '2' AND a.apartment_number = 'Lgh 1001/105'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Sharmarke Ali' AND t.last_name = 'Hussein'
AND a.street = 'Västra Vittusgatan' AND a.number = '2' AND a.apartment_number = 'Lgh 1002/106'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Konrad Karol' AND t.last_name = 'Koblak'
AND a.street = 'Västra Vittusgatan' AND a.number = '2' AND a.apartment_number = 'Lgh 1102/108'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;

INSERT INTO tenant_apartments (tenant_id, apartment_id)
SELECT t.id, a.id FROM tenants t
JOIN apartments a ON t.first_name = 'Sompong' AND t.last_name = 'Rosenius'
AND a.street = 'Västra Vittusgatan' AND a.number = '2' AND a.apartment_number = 'Lgh 1101/109'
ON DUPLICATE KEY UPDATE tenant_id = tenant_id;
...
-- Ange nÃ¶dvÃ¤ndiga behÃ¶righeter fÃ¶r anvÃ¤ndaren
